...
export function MakeConstructor(F, writablePrototype, prototype) {
  ...
  if (isECMAScriptFunctionObject(F)) {
    ...
    Assert(X(IsExtensible(F)) === Value.true && X(HasOwnProperty(F, Value.of('prototype'))) === Value.false);
  ...
  if (prototype === undefined) {
    ...
    X(DefinePropertyOrThrow(prototype, Value.of('constructor'), Descriptor({
      Value: F,
...
export function SetFunctionName(F, name, prefix) {
  ...
  Assert(IsExtensible(F) === Value.true && HasOwnProperty(F, Value.of('name')) === Value.false);
  ...
  if (name instanceof SymbolValue) {
    ...
    if (description === Value.undefined) {
      ...
      name = Value.of(`[${description.stringValue()}]`);
    }
  ...
  if (prefix !== undefined) {
    ...
    name = Value.of(`${prefix.stringValue()} ${name.stringValue()}`);
  ...
  return X(DefinePropertyOrThrow(F, Value.of('name'), Descriptor({
    Value: name,
...
export function SetFunctionLength(F, length) {
  ...
  Assert(IsExtensible(F) === Value.true && HasOwnProperty(F, Value.of('length')) === Value.false);
  ...
  return X(DefinePropertyOrThrow(F, Value.of('length'), Descriptor({
