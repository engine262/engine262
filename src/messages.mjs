...
export const AwaitInFormalParameters = () => 'await is not allowed in async function parameters';
...
export const YieldInFormalParameters = () => 'yield is not allowed in generator parameters';
