...
import { isTemporalPlainDateTimeObject } from './PlainDateTime.mts';
...
export function TimeRecordToString(time: TimeRecord, precision: number | 'minute' | 'auto'): PlainCompletion<string> {
