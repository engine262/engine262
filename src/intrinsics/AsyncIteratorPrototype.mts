...
function AsyncIteratorPrototype_AtAt_asyncIterator(_args: Arguments, { thisValue }: FunctionCallContext) {
...
export function bootstrapAsyncIteratorPrototype(realmRec: Realm) {
  const proto = bootstrapPrototype(realmRec, [
    [wellKnownSymbols.asyncIterator, AsyncIteratorPrototype_AtAt_asyncIterator, 0],
