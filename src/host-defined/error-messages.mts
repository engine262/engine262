...
'"$1" is required on object $2'
  ...
  | '$1 is not a $2'
  | '$1 is not a valid TemporalDurationString ($2)'
  | '$1 is not a valid UTC offset string: $2'
  | '$1 is not a valid time zone identifier: $2'
  | '$1 is not a valid time zone string: $2'
