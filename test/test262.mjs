...
const excludedTests = new Set([
  ...
  'test/built-ins/TypedArray/prototype/every/callbackfn-arguments-with-thisarg.js',
  'test/built-ins/TypedArray/prototype/every/callbackfn-arguments-without-thisarg.js',
  'test/built-ins/TypedArray/prototype/every/callbackfn-detachbuffer.js',
  'test/built-ins/TypedArray/prototype/every/callbackfn-no-interaction-over-non-integer.js',
  'test/built-ins/TypedArray/prototype/every/callbackfn-not-callable-throws.js',
  'test/built-ins/TypedArray/prototype/every/callbackfn-not-called-on-empty.js',
  'test/built-ins/TypedArray/prototype/every/callbackfn-return-does-not-change-instance.js',
  'test/built-ins/TypedArray/prototype/every/callbackfn-returns-abrupt.js',
  'test/built-ins/TypedArray/prototype/every/callbackfn-set-value-during-interaction.js',
  'test/built-ins/TypedArray/prototype/every/callbackfn-this.js',
  'test/built-ins/TypedArray/prototype/every/detached-buffer.js',
  'test/built-ins/TypedArray/prototype/every/get-length-uses-internal-arraylength.js',
  ...
  'test/built-ins/TypedArray/prototype/every/returns-false-if-any-cb-returns-false.js',
  ...
  'test/built-ins/TypedArray/prototype/every/values-are-not-cached.js',
  ...
  'test/built-ins/TypedArray/prototype/find/detached-buffer.js',
  ...
  'test/built-ins/TypedArray/prototype/findIndex/detached-buffer.js',
  'test/built-ins/TypedArray/prototype/findIndex/get-length-ignores-length-prop.js',
  ...
  'test/built-ins/TypedArray/prototype/findIndex/predicate-call-changes-value.js',
  'test/built-ins/TypedArray/prototype/findIndex/predicate-call-parameters.js',
  'test/built-ins/TypedArray/prototype/findIndex/predicate-call-this-non-strict.js',
  'test/built-ins/TypedArray/prototype/findIndex/predicate-call-this-strict.js',
  ...
  'test/built-ins/TypedArray/prototype/findIndex/predicate-not-called-on-empty-array.js',
  'test/built-ins/TypedArray/prototype/findIndex/prop-desc.js',
  'test/built-ins/TypedArray/prototype/findIndex/return-abrupt-from-predicate-call.js',
  'test/built-ins/TypedArray/prototype/findIndex/return-index-predicate-result-is-true.js',
  'test/built-ins/TypedArray/prototype/findIndex/return-negative-one-if-predicate-returns-false-value.js',
  ...
  'test/built-ins/TypedArray/prototype/forEach/arraylength-internal.js',
  'test/built-ins/TypedArray/prototype/forEach/callbackfn-arguments-with-thisarg.js',
  'test/built-ins/TypedArray/prototype/forEach/callbackfn-arguments-without-thisarg.js',
  'test/built-ins/TypedArray/prototype/forEach/callbackfn-detachbuffer.js',
  'test/built-ins/TypedArray/prototype/forEach/callbackfn-is-not-callable.js',
  'test/built-ins/TypedArray/prototype/forEach/callbackfn-no-interaction-over-non-integer.js',
  'test/built-ins/TypedArray/prototype/forEach/callbackfn-not-called-on-empty.js',
  'test/built-ins/TypedArray/prototype/forEach/callbackfn-return-does-not-change-instance.js',
  'test/built-ins/TypedArray/prototype/forEach/callbackfn-returns-abrupt.js',
  'test/built-ins/TypedArray/prototype/forEach/callbackfn-set-value-during-interaction.js',
  'test/built-ins/TypedArray/prototype/forEach/callbackfn-this.js',
  'test/built-ins/TypedArray/prototype/forEach/detached-buffer.js',
  ...
  'test/built-ins/TypedArray/prototype/forEach/returns-undefined.js',
  ...
  'test/built-ins/TypedArray/prototype/forEach/values-are-not-cached.js',
